...
public class Tests {
    ...
    public static void hw3tests() throws OperationNotSupportedException{
        ...
        try {
            ...
            row3.insertAtPosition(P, 1);
            //row3.insertAtPosition(button, 2); // Insert button into row3
            row2.insertAtPosition(button, 3);
            window.setContents(border); // Set the border containing all components as the window content
